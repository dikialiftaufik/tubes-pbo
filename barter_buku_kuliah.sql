...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 22 Mar 2026 pada 08.08
...
--
-- Struktur dari tabel `trust_score_history`
--
...
--
-- Dumping data untuk tabel `trust_score_history`
--
...
--
-- Indeks untuk tabel `trust_score_history`
--
...
--
-- AUTO_INCREMENT untuk tabel `trust_score_history`
--
ALTER TABLE `trust_score_history`
...
--
-- Ketidakleluasaan untuk tabel `trust_score_history`
--
ALTER TABLE `trust_score_history`
